    ...
    <header className="bg-white border-b border-gray-200 px-4 lg:px-6 py-3 sticky top-0 z-30">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:block">{/* This space can be used for breadcrumbs or search in the future */}</div>
        </div>
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-10 w-10 rounded-full hover:bg-gray-100 transition-colors">
                <Avatar className="h-10 w-10">
                  <AvatarImage src="/placeholder.svg?height=40&width=40&text=Avatar" alt={user?.name} />
                ...
                <div className="flex flex-col space-y-2">
                  <div className="flex items-center gap-3">
                    <Avatar className="h-12 w-12">
                      <AvatarImage src="/placeholder.svg?height=48&width=48&text=Avatar" alt={user?.name} />
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-xs leading-none text-muted-foreground mt-1">Administrator</p>
                    </div>
                  </div>
                </div>
              </DropdownMenuLabel>
